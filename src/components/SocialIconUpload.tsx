...
interface SocialIconUploadProps {
  onIconUpload: (url: string) => void;
  currentIconUrl?: string | null;
}

const SocialIconUpload: React.FC<SocialIconUploadProps> = ({ onIconUpload, currentIconUrl }) => {
  ...
  const handleFileChange = async (event: React.ChangeEvent<HTMLInputElement>) => {
    try {
      ...
      // Usando um bucket genérico para ícones sociais
...
export default SocialIconUpload